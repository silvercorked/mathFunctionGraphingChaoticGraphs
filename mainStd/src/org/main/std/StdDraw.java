...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    *************************************************************************/
    ...
    //begin of alex methods
    double oldX;
    double oldY;
    private void lineDraw(double x, double y) {
		if(oldX != 0.0 && oldY != 0.0){
			System.out.println(this.getCallerClassName());
		}
		oldX = x;
		oldY = y;
	}
    public String getCallerClassName(){
    	...
    	for(int i = 0; i < stElements.length-1; i++){
